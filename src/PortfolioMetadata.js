export default [
  ...
  },
  {
    ...
    content: [
      ...
      {type: 'image', name: 'AnyQ_2'},
      {
        ...
        columns: {
          left: [
            'Greater use of visuals and cultural design elements create an uplifting experience that maintains engagement with New Zealand school students. We held a number of user testing group sessions with various school students around New Zealand who were excited to see characters that embodied similar physical appearances and personality traits to their own.'
          ],
          right: [
            'I was the lead designer of this project and worked in a team of talented developers and scrum masters. My role embodied re-designing the brand, designing responsive interfaces, undergoing user testing sessions and integrating and designing characters. This project is due to launch early 2017.',
            'Meet the kids of AnyQuestions:'
          ]
        },
      },
    ...
    content: [
      {
        ...
        columns: {
          left: [
            'User experience and conveying information harmoniously was key in this project; who wants to deal with a difficult interface when there power is out?'
          ],
          right: [
            'Many New Zealand residents and businesses rely on Powerco to deliver their energy safely and securely. Powerco wanted a mobile application to develop better relationships with their customers by notifying them of any upcoming power outages as well as allowing users to notify if they were experiencing an unplanned power outage.'
          ]
        }
      },
  ...
  },
  {
    ...
    hoverSubHeader: 'The main hurdle in this project came in the form of educating children. Including Laika became a great approach to assist their learning of space expeditions.',
    skills: [
      'Illustration',
      'Character Design'
    ],
  ...
  },
  {
    ...
    hoverSubHeader: 'I created these to add an element of fun and help reinforce the numbered values visually through playful illustrations.',
    skills: [
      'Illustration',
    ],
    content: [
      {
        ...
        columns: {
          left: [
            'I created these to add an element of fun and help reinforce the numbered values visually through playful illustrations.'
          ],
          right: [
            'Planning poker (aka Scrum poker) is a gamified technique for estimating effort or the relative size of development goals in software development. To start a session the product owner or customer reads an Agile user story and each estimator holds a deck and places a card with a number that they feel represents the value of the story. There are four deck designs each with a different theme: Outer Space, Under the Sea, Dinosaur Kingdom and Dessert Time.'
          ],
        },
      },
